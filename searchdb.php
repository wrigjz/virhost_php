...
# A test input and check if we were given any inputs
#$input1 = "herpes";
if ($input1 != true ) {
...
# Now access the DB and get the data we want back from it, we use PHP native SQLite commands
# we have to do this once to test if there is any output and then rewind the DB to start again
# to get the actual output if there is any becasue the test takes the 1st result that comes back if
# it is positive
...
### At this point we should have the data from the DB so we can now test the results and print them
